...
axesSettings.forEach(setting => {
  setting.onchange = function() {
    ...
    // When the user selects an x-axis variable, the y-axis variable is revealed for the user to select
    if(xAxisValue != ' -- select an option -- '){
      yAxisDetails.classList.remove('hidden-axis')
      // yAxisDetails.classList.add('visible-axis')
    }
